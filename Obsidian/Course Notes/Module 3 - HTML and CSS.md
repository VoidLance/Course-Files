...
- Content within div [[Tags/Tags]] should be tabbed to indicate that it is contained
...
- Internal CSS is just external CSS, contained within `<style>` [[Tags/Tags]].
...
- Nav and section elements are [[Semantic Elements 1]] which function the same as divs, but are more appropriately named for their usage
- (Apparently we're only just getting to list elements being used in navbar links)
- When using anchor [[Tags/Tags]], we should always use relative urls if possible
...
- <code>Everything inside code [[Tags/Tags]] will be formatted as code</code>
...
[[Display and Layout of HTML Elements 1]] is extremely important
