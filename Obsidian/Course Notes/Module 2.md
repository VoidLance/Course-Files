...
- `<html>` [[Tags/Tags]] define the root element of the document. 
- Everything inside `<html>` [[Tags/Tags]] is "nesting", or nested within the [[Tags/Tags]].
- When you create `<html>` [[Tags/Tags]], you are informing the page that this is the root html element.
...
- `</head>`
- `<body>`
	- text goes in as text, other elements go in as [[Tags/Tags]]
- `</body>`
...
- to turn an image into a link, wrap the `<img>` tag inside `<a></a>` [[Tags/Tags]]
...
This also links to [[Module 3 - HTML and CSS 1]]
